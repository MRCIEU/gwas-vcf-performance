...
while read line; do
    ...
    awk -v pthresh="$pthresh" -F"\t" '$8 > pthresh' /data/gwas.txt | wc -l >> /data/pval.query.uncompressed.text.awk.counts.txt
done < /data/pval.txt
...
while read line; do
    ...
    awk -v pthresh="$pthresh" -F"\t" '$8 > pthresh' | wc -l >> /data/pval.query.compressed.text.awk.counts.txt
done < /data/pval.txt
