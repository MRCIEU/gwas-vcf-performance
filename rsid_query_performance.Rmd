...
while read snp; do
    ...
    awk -v snp="$snp" -F"\t" '$8==snp' /data/gwas.txt | wc -l >> /data/rsid.query.uncompressed.text.awk.counts.txt
done < /data/rsid.txt
...
while read snp; do
    ...
    awk -v snp="$snp" -F"\t" '$8==snp' | wc -l >> /data/rsid.query.compressed.text.awk.counts.txt
done < /data/rsid.txt
...
while read snp; do
    ...
    rsidx search /data/gwas.vcf.gz dbsnp.v153.b37.vcf.gz.rsidx "$snp" | wc -l >> /data/rsid.query.compressed.vcf.rsidx.counts.txt
done < /data/rsid.txt
```
